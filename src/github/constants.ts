...
export const CANCELLATION_MESSAGE_REVIEW_PR = 'Pull request review was cancelled';
export const CANCELLATION_MESSAGE_GET_PR_DIFF = 'Pull request diff retrieval was cancelled';
